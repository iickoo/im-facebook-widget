...
class IMFBW_Widget_Facebook_Pagelikebox extends WP_Widget {
  ...
  function __construct() {
    parent::__construct(
      ...
      array( 'description' => __( 'Widget for Facebook fanpage like, share, timeline, events, messages and more options.', IMFBW_PLUGIN_NAME ), )
    );
  }
  ...
  public function widget( $args, $instance ) {
    ...
    wp_localize_script( 'imfbw_plb', 'imfbw_plb_var', array(
    	'language'  => $current_language,
      'appid'     => $appid
    ) );
    wp_enqueue_script( 'imfbw_plb' );
    ...
    <div class="imfbw-box">
      ...
      <div id="fb-root"></div>
        ...
        data-hide-cta="<?php echo $hide_cta ?>"
				...
				data-show-facepile="<?php echo $show_facepile ?>"></div>
		</div>
    <?php
		echo $after_widget;
  }
  ...
  public function form( $instance ) {
    ...
    if(true === $availableFacebookLanguage['status']){
